...
public class ChatBot extends PircBot {
			...
			String login, String hostname, String message)
	{
		...
		if(message.toLowerCase().indexOf(keywords[0].toLowerCase()) != -1) {
			...
			// Check for a zip code in the message
			...
			if(temps[0].equals(-100000.0)) {
				// Send message to the channel
				sendMessage(channel, sender + ": The given zipcode is invalid.");
			}
			else {
				...
				sendMessage(channel, sender + ": The weather is " + temps[0]
						+ "°C with a high of " + temps[1] + "°C and a low of " + temps[2] + 
						"°C. The pressure is " + temps[3]);
